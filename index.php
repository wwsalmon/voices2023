...
?>
    <div class="w-full flex items-stretch">
        <img src="<?php echo get_template_directory_uri() . '/img/hero.jpg'; ?>" alt="Photo of Voices fellow standing against AAJA backdrop onstage" class="w-2/5 object-cover block">
        <div class="w-3/5">
            <div class="max-w-2xl ml-16 py-24">
                <p class="text-5xl leading-snug font-ss mb-16">
    ...
    <div class="w-full bg-tpurple py-24 text-white">
